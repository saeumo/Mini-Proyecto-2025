...
En primer lugar, el filete de pechuga con 153 ventas, en segundo lugar el queso
en lonchas de cabra con 153 ventas, seguido de el queso arzua con 141 ventas, 
a continuación el atún claro de oliva en pack de 6 con 125 unidades y por último
lugar el plátano con 111 ventas.

```{r ventas_top5, echo=FALSE}
knitr::kable(ventas_top5, caption = "Top 5 productos más vendidos por unidad")
```
