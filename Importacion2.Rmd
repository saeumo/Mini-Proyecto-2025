...
el kilo de plátano...*Véase en la Figura 3*
...
ggplot(frutas_con_fecha, aes(x = fecha, y = precio_unitario, color = nombre)) +
  ...
  labs(
    title = "Figura 3: Evolución del Precio por Kilo",
...
#Seleccionamos la primera fila ya que la tabla está ordenada de modo decreciente, quedando así el valor mas alto en la primera fila
hora_mas_frecuente <- compras_por_turno[1,]
...
-Como podemos observar, el producto que cuando se compra, se hace en mayor
